...
export default function DesignSection() {
  return (
    <div id="design" className="mt-4 lg:mt-[12%] pt-[100px] lg:pt-[200px]">
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  The fuel cell requires oxygen, which can be obtained from the
                  air. Ensure proper ventilation and intake for the required
                  amount of oxygen.
                </p>
              </li>
            </ul>
            ...
            <ul>
              <li>
                <p className="mt-5">
                  ...
                  This system manages the electricity generated by the fuel cell
                  and distributes it to the propulsion system and other onboard
                  systems.
                </p>
              </li>
              <li>
            ...
            <ul>
              <li>
                <p className="mt-5">
                  ...
                  Implement a cooling system for the fuel cell stack to maintain
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  Distribute the weight of the hydrogen storage, fuel cell, and
                  other components to maintain stability
                </p>
              </li>
            </ul>
          </article>
            ...
            <ul>
              <li>
                <p className="mt-5">
                  ...
                  Consider the availability of hydrogen refueling infrastructure
                  or plan for on-board hydrogen generation (e.g., electrolysis).
                </p>
              </li>
            </ul>
          </article>
            ...
            <ul>
              ...
              <li>
                <p className="mt-5">
                  ...
                  Consider the maintenance requirements for the fuel cell system
